...
function ToastIcon({ variant }: { variant: ToastVariant }) {
  ...
  if (variant === "success")
    return (
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={`h-4 w-4 shrink-0 ${cls}`}>
    ...
    >
      {toasts.map((t) => {
        ...
        return (
          ...
          >
            {/* Colour bar */}
            <div className={`w-1 shrink-0 self-stretch rounded-l-xl ${s.bar}`} />
